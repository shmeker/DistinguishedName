...
{
	/// <summary>
	/// Common name known type.
	/// </summary>
	public sealed class CommonName : SingleValued
	{
		/// <summary>
		/// Static getter for name.
		/// </summary>
		public static string Name => "CN";

		/// <summary>
		/// Static getter for dotted-decimal name.
		/// </summary>
		public static string DottedName => "2.5.4.3";

		/// <summary>
		/// Getter for Relative Distinguished Name type.
		/// </summary>
		public override RdnTypes RdnType => RdnTypes.CommonName;
		...
		public CommonName(string value, bool isDottedType)
			: base(isDottedType)
		{
			Value = value;
		}
